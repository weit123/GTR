...
def get_args():
    ...
    parser.add_argument("--repitition_penalty", type=float, default=1.2)
    parser.add_argument("--top_p", type=float, default=None)
    parser.add_argument("--disable_sample", default=True, action='store_false')
